...
按需复制（不全量安装）：Button / Input / Dialog / Select / Tabs / Card / Avatar / Badge / Progress / Tooltip。复制到 `components/ui/`。所有 primitives 必须服务于控制台体验：紧凑、可扫读、点击后 100ms 内有 active / pending / skeleton 反馈。
