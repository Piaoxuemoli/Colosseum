  ...
  return (
    <Dialog open={open} onOpenChange={(nextOpen) => setDismissed(!nextOpen)}>
      <DialogContent className="max-w-md">
        ...
        <div className="rounded-lg border border-cyan-300/15 bg-cyan-300/5 px-4 py-3 text-sm text-muted-foreground">
        ...
        <div className="space-y-2">
          {sorted.map((player, index) => {
            ...
            return (
              <div key={player.agentId} className="flex items-center gap-3 rounded-lg border border-white/10 bg-slate-900/55 px-3 py-2">
